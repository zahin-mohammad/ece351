...
public final class Waveform implements Examinable {
	...
	public String toString() {
		StringBuilder waveformBuilder = new StringBuilder();
		waveformBuilder.append(name + ": ");
		for (String bit: bits){
			waveformBuilder.append(bit + " ");
		}
		waveformBuilder.append(";");
		return waveformBuilder.toString();
	}
